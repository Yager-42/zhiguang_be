...
For zhiguang_be Trellis customization or brownfield spec bootstrap, load `zhiguang-trellis-flow` after classification and follow its conditional skill routing.
[/workflow-state:no_task]
