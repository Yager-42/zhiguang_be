...
Defines the API and persistence behavior for comments, replies, asynchronous comment writes, comment text ownership, deletion, likes, and comment-related counts.
